...
<body>
    ...
    <header class="tp-header-height">
        ...
        <div class="header-area-start">
                ...
                <div class="container-fluid">
                    <div class="row align-items-center">
                                ...
                                <ul>
                                    <li>
                                        <a href="https://www.google.com/maps/@41.6758525,-86.2531698,18.17z"><i
                                                class="fa-sharp fa-regular fa-location-dot"></i> Manchester 21, Zurich,
                                            CH</a>
                                    </li>
                                    <li>
                                        <a href="mailto:example@gmaol.com"><i class="fa-regular fa-envelope"></i>
                                            example@gmail.com</a>
                                    </li>
                        ...
                        <div class="col-lg-4 col-xl-3">
                            <div
                                class="tp-header-social-icon tp-header-social-icon-home tp-header-about-social-icon d-flex justify-content-end">
            ...
            <!-- header-bootom-start -->
            <div class="header-bootom-area tp-header-menu-spacing section-plr p-relative tp-white-bg"
                id="tp-header-sticky">
                <div class="container-fluid">
                    <div class="row align-items-center">
                                    ...
                                    <ul>
                                        <li class="has-dropdown position-static">
                                            ...
                                            <div class="tp-submenu submenu has-homemenu">
                                                <div
                                                    class="row gx-6 row-cols-2 row-cols-md-2 row-cols-lg-2 row-cols-xl-5">
                                                    <div class="col homemenu">
                                                        <div class="homemenu-thumb mb-15">
                                                            <img src="../assets/img/menu/img-1.jpg" alt="">
                                                            <div class="homemenu-btn">
                                                                <a class="menu-btn tp-btn" href="index.html">Multi
                                                                    Page</a> <br>
                                                                <a class="menu-btn tp-btn tp-btn-green"
                                                                    href="index1-one-page.html">One Page</a>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col homemenu">
                                                        <div class="homemenu-thumb mb-15">
                                                            ...
                                                            <div class="homemenu-btn">
                                                                <a class="menu-btn tp-btn" href="index-2.html">Multi
                                                                    Page</a> <br>
                                                                <a class="menu-btn tp-btn tp-btn-green"
                                                                    href="index2-one-page.html">One Page</a>
                                                            </div>
                                                        </div>
                                                        <div class="homemenu-content text-center">
                                                            <h4 class="homemenu-title">
                                                    ...
                                                    <div class="col homemenu">
                                                        <div class="homemenu-thumb mb-15">
                                                            ...
                                                            <div class="homemenu-btn">
                                                                <a class="menu-btn tp-btn" href="index-3.html">Multi
                                                                    Page</a> <br>
                                                                <a class="menu-btn tp-btn tp-btn-green"
                                                                    href="index3-one-page.html">One Page</a>
                                                            </div>
                                                        </div>
                                                        <div class="homemenu-content text-center">
                                                            <h4 class="homemenu-title">
                                                    ...
                                                    <div class="col homemenu">
                                                        <div class="homemenu-thumb mb-15">
                                                            ...
                                                            <div class="homemenu-btn">
                                                                <a class="menu-btn tp-btn" href="index-4.html">Multi
                                                                    Page</a> <br>
                                                                <a class="menu-btn tp-btn tp-btn-green"
                                                                    href="index4-one-page.html">One Page</a>
                                                            </div>
                                                        </div>
                                                        <div class="homemenu-content text-center">
                                                            <h4 class="homemenu-title">
                                                    ...
                                                    <div class="col homemenu">
                                                        <div class="homemenu-thumb mb-15">
                                                            ...
                                                            <div class="homemenu-btn">
                                                                <a class="menu-btn tp-btn" href="index-5.html">Multi
                                                                    Page</a> <br>
                                                                <a class="menu-btn tp-btn tp-btn-green"
                                                                    href="index5-one-page.html">One Page</a>
                                                            </div>
                                                        </div>
                                                        <div class="homemenu-content text-center">
                                                            <h4 class="homemenu-title">
                                                    ...
                                                    <div class="col homemenu">
                                                        <div class="homemenu-thumb mb-15">
                                                            ...
                                                            <div class="homemenu-btn">
                                                                <a class="menu-btn tp-btn" href="index-6.html">Multi
                                                                    Page</a> <br>
                                                                <a class="menu-btn tp-btn tp-btn-green"
                                                                    href="index6-one-page.html">One Page</a>
                                                            </div>
                                                        </div>
                                                        <div class="homemenu-content text-center">
                                                            <h4 class="homemenu-title">
                                                    ...
                                                    <div class="col homemenu">
                                                        <div class="homemenu-thumb mb-15">
                                                            ...
                                                            <div class="homemenu-btn">
                                                                <a class="menu-btn tp-btn" href="index-7.html">Multi
                                                                    Page</a> <br>
                                                                <a class="menu-btn tp-btn tp-btn-green"
                                                                    href="index7-one-page.html">One Page</a>
                                                            </div>
                                                        </div>
                                                        <div class="homemenu-content text-center">
                                                            <h4 class="homemenu-title">
                                                    ...
                                                    <div class="col homemenu">
                                                        <div class="homemenu-thumb mb-15">
                                                            ...
                                                            <div class="homemenu-btn">
                                                                <a class="menu-btn tp-btn" href="index-8.html">Multi
                                                                    Page</a> <br>
                                                                <a class="menu-btn tp-btn tp-btn-green"
                                                                    href="index8-one-page.html">One Page</a>
                                                            </div>
                                                        </div>
                                                        <div class="homemenu-content text-center">
                                                            <h4 class="homemenu-title">
                                                    ...
                                                    <div class="col homemenu">
                                                        <div class="homemenu-thumb mb-15">
                                                            ...
                                                            <div class="homemenu-btn">
                                                                <a class="menu-btn tp-btn" href="index-9.html">Multi
                                                                    Page</a> <br>
                                                                <a class="menu-btn tp-btn tp-btn-green"
                                                                    href="index9-one-page.html">One Page</a>
                                                            </div>
                                                        </div>
                                                        <div class="homemenu-content text-center">
                                                            <h4 class="homemenu-title">
                                ...
                                <ul class="d-flex align-items-center justify-content-end">
                                    ...
                                    <li class="tp-header-border">
                                        <div class="tp-header-cart lineheight-1">
                                            <button
                                                class="click-cart cartmini-open-btn tp-header-about-cart p-relative">
                    ...
                    <ul>
                        <li>
                            ...
                            <a href="https://www.google.com/maps/@41.6758525,-86.2531698,18.17z"
                                target="_blank">Manchester 21, Zurich, CH</a>
                        </li>
                        <li>
                            ...
                            <div class="tp-blog-sidebar-widget tp-blog-sidebar-widget-2 tp-blog-sidebar-widget-4 mb-30">
                                ...
                                <div class="tp-blog-post">
                                    <div class="tp-blog-post-thumb">
                                        <img src="blog_uploads/<?php echo $image; ?>" alt="blog">
                                    </div>
                                    <div class="tp-blog-content">
                                        <div class="tp-blog-meta-2">
                                            <span><i class="fa-sharp fa-light fa-comments"></i><?php echo date("j F Y", strtotime($blog['created_at'])); ?></span>
                                        </div>
                        ...
                        <div class="tp-footer-widget tp-footer-col-3">
                            ...
                            <div class="tp-footer-widget-content">
                                ...
                                <div class="tp-footer-widget-info">
                                    <a href="tel:+999212354685894"><i class="flaticon-telephone"></i> + 999 2123 5468
                                        5894</a>
                                    <a href="mailto:insuraihelp@mail.com"><i
                                            class="fa-sharp fa-regular fa-envelope"></i> insuraihelp@mail.com</a>
                                    <a href="https://www.google.com/maps/@41.6758525,-86.2531698,18.17z"><i
                                            class="fa-sharp fa-regular fa-location-dot"></i> 2307 Beverley Rd brook<br>
                                        New York 11226 U.S.</a>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="tp-footer-widget-form">
                                <form action="#">
                                    <div class="tp-footer-input">
                                        ...
                                        <button class="tp-footer-input-icon" type="submit"><i
