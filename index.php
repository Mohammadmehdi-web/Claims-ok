   ...
   ?>
    ...
    <main>
        ...
        <div class="tp-slider-family-area p-relative">
            ...
            <img class="tp-slider-family-shape-4 tptranslateX2 p-absolute"
                src="assets/img/banner/family/famely-shape1.png" alt="shape">
                ...
                <div class="row align-items-center">
                    <div class="col-xl-7 col-lg-6 mb-50">
                        <div class="tp-slider-family-content">
                            ...
                            <p class="tp-slider-title-pre-family mb-40  wow fadeInUp" data-wow-delay=".4s">We fight for
                                your
                                rights, ensuring that insurance companies honor their commitments. With Claims Ok, you
                                don’t
                            ...
                            <div class="tp-slider-saveing d-flex align-items-center  wow fadeInUp" data-wow-delay=".7s">
                                <div
                                    class="tp-slider-saveing-content tp-slider-saveing-border d-flex align-items-center mb-20">
                        ...
                        <div class="tp-about-thumb">
                            <div class="tp-about-family-img p-relative">
                                ...
                                <div class="tp-about-family-shape  d-none d-lg-block upslide p-absolute">
                                    <img class="tp-about-family-shape-2" src="assets/img/about/family/02.png"
                                        alt="shape">
                    ...
                    <div class="col-xl-7 col-lg-7 mb-40">
                        <div class="tp-about-content-wrapper-family">
                            <div class="tp-about-family-title">
                                <span class="section-title tp-section-title-pre-family  tp-split-in-right mb-10">Know
                                    About
                                    Claims Ok</span>
                                <h2 class="tp-section-title tp-section-title-dark  tp-split-in-left mb-30">Get Reliable
                                    & Quick
                                    Insurance for Your Family</h2>
                                <p class="tp-section-title-para mb-35">
                                    At Claims Ok, we believe that insurance claims should be easy, stress-free, and
                                    fair. But in
                                    reality, the process can be overwhelming, with endless paperwork, confusing
                                    policies, and
                                    unnecessary delays. That’s why we’re here – to simplify your insurance claim journey
                                    and
                    ...
                    <div class="col-lg-6 mb-40  wow fadeInRight" data-wow-delay="100ms">
                        <div class="tp-benifits-title-wrapper">
                            <span
                                ...
                                Benifits</span>
                            <h2 class="tp-section-title tp-section-title-busi mb-15 tp-split-in-left">We Inspire and Try
                                to
                                Help Customers</h2>
                            <p class="tp-section-title-para-busi mb-30">We exist to support you and help you in the time
                                of
                                ...
                                <div class="accordion" id="general_faqaccordion">
                                    <div class="accordion-item tp-benifits-faq-list">
                                        <h2 class="accordion-header" id="order_one">
                                            <button class="accordion-button tp-faq-btn-2" type="button"
                                        ...
                                        <div id="order__collapse_one" class="accordion-collapse collapse show"
                                            ...
                                            <div class="accordion-body tp-faq-details-para p-relative">
                                                <p>We provide a wide range of insurance options, including Home, Car,
                                                    Life, and
                                    ...
                                    <div class="accordion-item tp-benifits-faq-list">
                                        ...
                                        <div id="order__collapse_two" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body tp-faq-details-para p-relative">
                                                <p>Our experts analyze your requirements and suggest the most suitable
                                                    coverage,
                                    ...
                                    <div class="accordion-item tp-benifits-faq-list">
                                        ...
                                        <div id="order__collapse_three" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body tp-faq-details-para p-relative">
                                                <p>Filing a claim is simple! Just contact our support team, submit the
                                                    necessary
        ...
        <div class="tp-service-area-family tp-orange-bg pt-135 pb-140">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div class="tp-service-title-family mb-55 text-center">
                            <span class="tp-section-title-pre-family section-title tp-split-in-right mb-10">What We
                                Provide to
                                Our
                                Customers</span>
                ...
                <div class="row tp-service-spacing">
                    <div class="col-xl-3 col-lg-6 col-md-6 mb-60 wow fadeInUp" data-wow-duration=".9s"
                        data-wow-delay=".4s">
                        <div class="tp-service-content-wrapper tp-service-colum-1 text-center">
                            ...
                            <div class="tp-service-content-">
                                ...
                                <p class="tp-service-para mb-20">Secure your home with flexible coverage and peace of
                                    mind.
                                </p>
                                <span class="tp-service-icon-2"><a href="#"><i
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 mb-60 wow fadeInUp" data-wow-duration=".9s"
                        ...
                        <div class="tp-service-content-wrapper tp-service-colum-2 text-center">
                            ...
                            <div class="tp-service-content-">
                                ...
                                <p class="tp-service-para mb-20">Drive worry-free with our reliable and affordable
                                    plans.
                                </p>
                                <span class="tp-service-icon-2"><a href="#"><i
                                            class="flaticon-right-arrow"></i></a></span>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 mb-60 wow fadeInUp" data-wow-duration=".9s"
                        ...
                        <div class="tp-service-content-wrapper tp-service-colum-3 text-center">
                            ...
                            <div class="tp-service-content-">
                                ...
                                <p class="tp-service-para mb-20">Protect your loved ones with a future-ready insurance
                                    plan.
                                </p>
                                <span class="tp-service-icon-2"><a href="#"><i
                                            class="flaticon-right-arrow"></i></a></span>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 mb-60 wow fadeInUp" data-wow-duration=".9s"
                        ...
                        <div class="tp-service-content-wrapper tp-service-colum-4 text-center">
                            ...
                            <div class="tp-service-content-">
                                ...
                                <p class="tp-service-para mb-20">Stay covered with the best medical protection for you
                                    and your
                                    family.
                                </p>
                                <span class="tp-service-icon-2"><a href="#"><i
                ...
                <div class="row mb-15 d-flex align-items-end">
                    ...
                    <div class="col-lg-6 mb-45">
                        <div class="tp-testimonial-navigation f-right">
                            <span class="tp-testimonial-family-prev"><i class="fa-solid fa-arrow-left"></i></span>
                            <span class="tp-testimonial-family-next"><i class="fa-solid fa-arrow-right"></i></span>
        ...
        <div class="tp-contact-area  pb-140 p-relative">
            <img class="tp-contact-shape-2 tree-move p-absolute" src="assets/img/contact/contact-shape-2.png"
                alt="shape">
                            ...
                            <div class="row">
                                <div class="col-lg-5 pb-40">
                                    <div class="tp-contact-content p-relative h-100">
                                        ...
                                        <h3 class="tp-contact-title section-title tp-split-in-left mb-20">Let’s Talk
                                            With<br>
                                            Experience<br> Advisors.</h3>
                                        <p class="tp-contact-para">Have questions or need assistance? Fill out the form
                                            below, and
                                            our experts will get back to you shortly!</p>
                                    </div>
                                </div>
                                <div class="col-lg-2 pb-40">
                                    <div class="nav tp-contact-list" id="v-pills-tab" role="tablist"
                                ...
                                <div class="col-lg-5 pb-40">
                                    <div class="tp-contact-form-wrapper tp-black-bg9  tab-content"
                                                ...
                                                <form action="#">
                                                    ...
                                                    <div class="tp-contact-input mb-15">
                                                        <select name="query_type">
                                                            <option value="" disabled selected>Select Query Type
                                                            </option>
                                                    ...
                                                    <div
                                                        ...
                                                        <button class="tp-btn tp-btn-green mr-30" type="submit">Send
                                                            Message</button>
                                                    </div>
                                                </form>
                                            </div>
                    ...
                    <div class="col-xl-5 col-lg-7 col-md-8 col-sm-12 wow fadeInUp" data-wow-delay=".2s"
                        ...
                        <div class="tp-contact-health-bg mt-180 mb-180">
                            <div class="tp-contact-health-content">
                                <h2 class="tp-contact-health-title mb-30"> Got Questions? <span>We’ve Got
                                        Answers!</span> 👋
                                </h2>
                    ...
                    <div class="col-12 mb-40">
                        <div class="tp-blog-title-wrapper text-center">
                            <span class="tp-section-title-pre-family section-title tp-split-in-right">Read Our
                                Blog</span>
                            <h2 class="tp-section-title tp-section-title-dark tp-split-in-left">Our latest News &
                                Articles</h2>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 mb-35 wow fadeInUp" data-wow-duration=".9s"
                        ...
                        <div class="tp-blog-wrapper tp-blog-wrapper-family">
                            ...
                            <div class="tp-blog-content-family">
                                ...
                                <h3 class="tp-blog-title tp-blog-title-family mb-30">
                                    <a href="blog-details.html">Wise Spending Habits, 13 Tips for Maximizing Your
                                        Money</a>
                                </h3>
                                <div class="tp-blog-date-family">
                                    <span><i class="fa-light fa-calendar"></i> December 22, 2024</span>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 mb-35 wow fadeInUp" data-wow-duration=".9s"
                        ...
                        <div class="tp-blog-wrapper tp-blog-wrapper-family">
                            ...
                            <div class="tp-blog-content-family">
                                ...
                                <h3 class="tp-blog-title tp-blog-title-family mb-30">
                                    <a href="blog-details.html">With Christmas Just Around the Corner, it’s
                                        Important</a>
                                </h3>
                                <div class="tp-blog-date-family">
                                    <span><i class="fa-light fa-calendar"></i> December 22, 2024</span>
